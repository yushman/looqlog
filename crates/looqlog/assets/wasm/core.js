...
export class ParserHandle {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        ParserHandleFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_parserhandle_free(ptr, 0);
    }
    /**
     * @returns {number}
     */
    blankLines() {
        const ret = wasm.parserhandle_blankLines(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    detection() {
        try {
            ...
            wasm.parserhandle_detection(retptr, this.__wbg_ptr);
    ...
    diagnosticsSummary() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.parserhandle_diagnosticsSummary(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
     ...
     */
    entriesEmitted() {
        const ret = wasm.parserhandle_entriesEmitted(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    feed(chunk) {
        try {
            ...
            wasm.parserhandle_feed(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    fieldInventory() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.parserhandle_fieldInventory(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    finish() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.parserhandle_finish(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    format() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.parserhandle_format(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            let v1;
            if (r0 !== 0) {
     ...
     * zones are out of scope — see `crates/looqlog-core/src/timestamp.rs`).
     ...
     * the boundary rather than being read inside `looqlog-core` because ADR-0005
    ...
    constructor(format_override, tz_offset_minutes, reference_ms) {
        try {
            ...
            this.__wbg_ptr = r0;
            ParserHandleFinalization.register(this, this.__wbg_ptr, this);
            return this;
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
     ...
     */
    totalLines() {
        const ret = wasm.parserhandle_totalLines(this.__wbg_ptr);
        return ret >>> 0;
    }
}
if (Symbol.dispose) ParserHandle.prototype[Symbol.dispose] = ParserHandle.prototype.free;
...
const ParserHandleFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_parserhandle_free(ptr, 1));
