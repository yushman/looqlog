...
The `security` capability covers the CSP, WebSocket origin check and per-process token
handshake that close the cross-tab WebSocket hijacking risk named in TDR §13, and the stated
limits of those measures.
## Requirements
